<header class="flex bg-black place-content-around items-center opacity-90 p-2 lg:flex-col">

  <a href="/trailery/index.php"><img class=" py-4 w-16 object-contain md:py-6 lg:flex justify-start w-24 xl:w-40" src="/trailery/asset/img/logosantitre.png"/img></a>
  <h1 class='text-white text-4xl md:text-5xl lg:pb-4 xl:text-6xl xl:pb-6'>Trailery</h1>
  ...
  <ul class="hidden lg:flex sticky bg-black/90 text-white p-2 justify-center xl:text-xl">
    ...
    <li><a class="px-2" href="/trailery/content/form/connection.php">Mon compte</a></li>
    <!--<li>Mon compte</li>!-->
  </ul>
...
<div class="hidden flex justify-end menu">
  ...
  <li><a href="/trailery/content/form/connection.php">Mon compte</a></li>
  <!--<li>Mon compte</li>!-->
  </ul>
