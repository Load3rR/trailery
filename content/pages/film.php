...
<body class="bg-[#BBBBBB] bg-fixed bg-[url('../../asset/img/bg.png')] bg-cover bg-no-repeat">
  ...
  include '../../header.php';
  require('../traitements/traitement_film.php');
  $image = $infoFilm['image'];
  //$id = $_GET['id_films'];
  ?>
  <//?php var_dump($infoFilm); ?>

  <h1 class="text-center text-2xl p-6 md:text-3xl lg:text-4xl xl:text-5xl m-8"><?php echo ($infoFilm['titre']); ?></h1>

  <div class="mx-4 mb-4 md:mb-8 md:mx-8 lg:mx-20 xl:flex justify-center">

    <img src="/trailery/asset/upload/<?php echo $image ?>" </img>

  </div>

  <div>
    <h2 class="text-center mb-4 md:text-xl md:mb-8 xl:text-2xl">Trailer :</h2>
    <div class="p-6 bg-white/50 pb-4 mb-8 mx-4 md:mx-8 lg:mx-20 xl:mx-56">

      <iframe class="w-full xl:h-[500px]" width="560" height="315" src="https://www.youtube.com/embed/<?php echo ($infoFilm['trailer']); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; 
            encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
      </iframe>

      <p class="pt-6"><?php echo ($infoFilm['synopsis']); ?></p>
      <p class="pt-6"><?php echo ($infoFilm['annee']); ?></p>

    </div>
  </div>


  <div id="carouselExampleCaptions" class="relative p-4 mb-4 rounded md:mx-4 lg:mx-20 lg:mb-8 xl:mx-56 xl:p-0" data-te-carousel-init data-te-carousel-slide>
    ...
    <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
      <div class="relative float-left -mr-[100%] w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none" data-te-carousel-active data-te-carousel-item style="backface-visibility: hidden">
        <img src="../../asset/img/pinon.jpg" class="block w-full" alt="..." />
  ...
  <footer class="flex bg-black p-4 items-center place-content-around absolute  right-0 left-0">
